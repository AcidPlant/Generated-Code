...
var file_order_v1_order_proto_depIdxs = []int32{
	0, // 0: order.v1.OrderService.SubscribeToOrderUpdates:input_type -> order.v1.OrderRequest
	1, // 1: order.v1.OrderService.SubscribeToOrderUpdates:output_type -> order.v1.OrderStatusUpdate
